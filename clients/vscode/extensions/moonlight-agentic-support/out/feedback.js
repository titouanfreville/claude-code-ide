...
exports.DEFAULT_REJECT_REASON = void 0;
exports.verdictTag = verdictTag;
exports.approves = approves;
exports.planBlocks = planBlocks;
...
exports.DEFAULT_REJECT_REASON = 'Plan rejected by operator — please revise and re-propose.';
/**
...
function preamble(verdict, count) {
 ...
 */
function reviewFeedback(plan, comments, verdict) {
 ...
 */
function denialReason(plan, comments, verdict) {
    if (comments.size === 0) {
        ...
        return `${verdictTag(verdict)} ${exports.DEFAULT_REJECT_REASON}`;
    }
