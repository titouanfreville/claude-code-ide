...
import type { DiscoverableSession, HookStatusEntry, SessionUsage, UsageResponse } from 'moonlight-control-client';
...
export declare const CORE_EXTENSION_ID = "titouanfreville.moonlight-core";
